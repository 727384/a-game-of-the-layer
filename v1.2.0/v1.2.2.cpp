...
void savegame()
{
	...
	fout << game.total1.x << " " << game.total4.e << endl;
	fout << game.total2.x << " " << game.total4.e << endl;
	fout << game.total3.x << " " << game.total4.e << endl;
...
void printscr(int x)
{
	...
	if (x == 1)
	{
		if (game.point < lBI_Infinity)
		{
			...
			cout << ")4 重置升级和点数，但将 Layer 0 乘数 * " << pow(max(lBI({1, 0}), game.point / game.maxpoint), game.rl0mul) << " 当前： " << game.multi << endl;
		}                                                                  
		else                                                             
		{                                                                    
