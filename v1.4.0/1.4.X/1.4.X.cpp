...
void update(char t, lBI gtick)
{
	...
	if (!game.break_infinity)
	{
		...
		if (game.l5dr4)
		{
			game.l5d3 += pow(pow(game.l5d4 * game.timetime, lBI(1) + lBI(0.08) * game.l5dr2), log10(game.total5) * lBI(3)) / Tick;
			game.l5d2 += pow(pow(game.l5d3 * game.timetime, lBI(1) + lBI(0.08) * game.l5dr2), log10(game.total5) * lBI(3)) / Tick;
			game.l5d1 += pow(pow(game.l5d2 * game.timetime, lBI(1) + lBI(0.08) * game.l5dr2), log10(game.total5) * lBI(3)) / Tick;
			game.l5d0 += pow(pow(game.l5d1 * game.timetime, lBI(1) + lBI(0.08) * game.l5dr2), log10(game.total5) * lBI(3)) / Tick;
		}
		else
		{
			game.l5d3 += pow(game.l5d4 * game.timetime, lBI(1) + lBI(0.08) * game.l5dr2) / Tick;
			game.l5d2 += pow(game.l5d3 * game.timetime, lBI(1) + lBI(0.08) * game.l5dr2) / Tick;
			game.l5d1 += pow(game.l5d2 * game.timetime, lBI(1) + lBI(0.08) * game.l5dr2) / Tick;
			game.l5d0 += pow(game.l5d1 * game.timetime, lBI(1) + lBI(0.08) * game.l5dr2) / Tick;
		}
		if (game.l5dr3)
		{
			game.l5point += LAYER4MUL;
