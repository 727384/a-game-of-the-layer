...
void buy(int layer, int update)
{
	...
	if (layer == 4)
	{	
		if (update == 1 && game.l5point >= game.l5d1c)
		{
			game.l4point -= game.l5d1c;
			game.l5d1c ++;
			game.l5d1 ++;
		}		
		if (update == 2 && game.l5point >= pow(lBI(10), lBI(1) * (game.l5d2c + lBI(1))))
		{
			game.l4point -= pow(lBI(10), lBI(1) * (game.l5d2c + lBI(1)));
			game.l5d2c ++;
			game.l5d2 ++;
		}		
		if (update == 3 && game.l5point >= pow(lBI(10), lBI(2) * (game.l5d3c + lBI(1))))
		{
			game.l4point -= pow(lBI(10), lBI(2) * (game.l5d3c + lBI(1)));
			game.l5d3c ++;
			game.l5d3 ++;
		}		
		if (update == 4 && game.l5point >= pow(lBI(10), lBI(4) * (game.l5d4c + lBI(1))))
		{
			game.l4point -= pow(lBI(10), lBI(4) * (game.l5d4c + lBI(1)));
			game.l5d4c ++;
			game.l5d4 ++;
		}
	}
...
void update(char t, lBI gtick)
{
	...
	game.l5d3 += game.l5d4 * game.timetime;
	game.l5d2 += game.l5d3 * game.timetime;
	game.l5d1 += game.l5d2 * game.timetime;
	game.l5d0 += game.l5d1 * game.timetime;
	if (game.point >= 1)
	{
		achs[0] = 1;
	}
