...
void layerreset(int layer)
{
	...
	if (layer == 2)
	{
		...
		game.timetime = 1;
		game.l4time ++;
		game.l4point += game.l4mul * game.dresult;
		game.total1 = 0;
		game.total2 = 0;
		game.total3 = 0;
		game.total4 += game.l4mul * game.dresult;
		game.pointcc = 0;
		game.autor = 0;
		game.layer1a = 0;
		game.bl1auc = 0;
	...
	if (page == 3)
	{
		...
		if (a == 4)
		{
			if (t == '1' && game.l4point >= pow(lBI(10), game.dice1c + lBI(1)))
			{
				...
				{
					game.dresult = lBI(rand() % int(game.dice2c + lBI(6)));
				}
			}
